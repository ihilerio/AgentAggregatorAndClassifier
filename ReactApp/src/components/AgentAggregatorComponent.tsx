...
import { AgentAggregatorComponentProps, AgentResponse } from './AgentAggregatorTypes';
                ...
                <Row className="bg-body-secondary">
                    ...
                    <Col className="col-10 text-start">
                        <label htmlFor="userInput">
                            Enter the name of the company you would like to get financial information from?
                            If you don't know the name, provide us a fact about the company so we can deduce it.
                        </label>
                    </Col>
                    <Col className="col-1"></Col>
                </Row>
                                    ...
                                    <div className="text-muted text-start">
                                        {response.companyInfo.businessAreas.length > 0 
                                            ? response.companyInfo.businessAreas.map((item, index) => (
                                                <span key={index}>{item}{index < response.companyInfo.businessAreas.length - 1 ? ', ' : ''}</span>
                                            ))
                                            : "N/A"
                                        }
                                    </div>
                                    ...
                                    <div className="text-muted text-start">
                                        {response.companyInfo.competitors.length > 0
                                            ? response.companyInfo.competitors.map((item, index) => (
                                                <span key={index}>{item}{index < response.companyInfo.competitors.length - 1 ? ', ' : ''}</span>
                                            ))
                                            : "N/A"
                                        }
                                    </div>
